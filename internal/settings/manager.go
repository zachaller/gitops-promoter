...
//   - PromotionEventHookConfiguration
type ControllerConfigurationTypes interface {
	promoterv1alpha1.PromotionStrategyConfiguration |
		...
		promoterv1alpha1.PromotionEventHookConfiguration
}
...
func getWorkQueueForController[T ControllerConfigurationTypes](ctx context.Context, m *Manager, direct bool) (promoterv1alpha1.WorkQueue, error) {
	...
	case promoterv1alpha1.PromotionEventHookConfiguration:
		if config.Spec.PromotionEventHook == nil {
			return promoterv1alpha1.WorkQueue{}, errors.New("PromotionEventHook configuration not found")
		}
		return config.Spec.PromotionEventHook.WorkQueue, nil
	default:
