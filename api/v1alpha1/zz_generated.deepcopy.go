...
func (in *DagCommitStatusStatus) DeepCopyInto(out *DagCommitStatusStatus) {
	*out = *in
	...
	if in.UnreferencedEnvironments != nil {
		in, out := &in.UnreferencedEnvironments, &out.UnreferencedEnvironments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make([]DagEnvironmentStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DagEnvironmentStatus) DeepCopyInto(out *DagEnvironmentStatus) {
	*out = *in
	if in.Parents != nil {
		in, out := &in.Parents, &out.Parents
		*out = make([]DagParentStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DagEnvironmentStatus.
func (in *DagEnvironmentStatus) DeepCopy() *DagEnvironmentStatus {
	if in == nil {
		return nil
	}
	out := new(DagEnvironmentStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DagParentStatus) DeepCopyInto(out *DagParentStatus) {
	*out = *in
	if in.CommitStatuses != nil {
		in, out := &in.CommitStatuses, &out.CommitStatuses
		*out = make([]ChangeRequestPolicyCommitStatusPhase, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DagParentStatus.
func (in *DagParentStatus) DeepCopy() *DagParentStatus {
	if in == nil {
		return nil
	}
	out := new(DagParentStatus)
	in.DeepCopyInto(out)
	return out
}
